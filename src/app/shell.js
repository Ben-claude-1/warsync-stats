...
export function renderShell(){
  ...
  document.getElementById('app').innerHTML=`
    ...
    <nav class="bnav">
      ...
      <button class="bni${APP.page==='basen'?' on':''}" onclick="nav('basen')"><svg viewBox="0 0 24 24"><polygon points="1 6 8 3 16 6 23 3 23 18 16 21 8 18 1 21"/><line x1="8" y1="3" x2="8" y2="18"/><line x1="16" y1="6" x2="16" y2="21"/></svg>Basen</button>
