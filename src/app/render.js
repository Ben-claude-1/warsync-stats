...
import { pageBasen } from '../ui/basen.js';
...
export function renderPage(){const el=document.getElementById('pc');if(!el)return;switch(APP.page){case'home':el.innerHTML=pageHome();break;case'ws':el.innerHTML=pageWS();break;case'cs':el.innerHTML=pageCS();break;case'vs':el.innerHTML=pageVS();break;case'zugfahrt':el.innerHTML=pageZugfahrt();break;case'allianz':el.innerHTML=pageAllianz();break;case'basen':el.innerHTML=pageBasen();break;case'umfragen':el.innerHTML=pageUmfragen();break;case'profil':el.innerHTML=pageProfil();break;case'admin':el.innerHTML=pageAdmin();break;case'rankings':pageRankings(el);break;default:el.innerHTML=pageHome();}}
